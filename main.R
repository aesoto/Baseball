...
# NOTE: SwingStrikes occur relatively rarely - approximately 6.83% of the time.
#       There are techniques to accommodate rare events and would require
#       adjustments to resampling, evaluating, and cross sampling.
#
...
#       - With larger data sets can mitigate overfitting
